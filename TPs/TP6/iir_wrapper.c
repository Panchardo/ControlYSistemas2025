...
//     iir_nth_df1_float(input, output); // usar esto con orden 6 mejora la respuesta, pero aparece como reflejada y retardada(en matlab se usa filtfilt que elimina ese retardo)
